...
def main():
    ...
    request_data = {
        ...
        "dateTo": "2023-08-06T23:59:59.999Z",
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for item in json_data[0]['Data']:
                query = ("INSERT INTO MandP_Data_withPython_Updated (consignmentNumber, clientname, BookingDate, consignee, pcs, SERVICE, name, WEIGHT, pieces, serviceTypeName, orderRefNo, deliveryDate, receivedBy, ReceiptAmount, DESTINATION, RRSTATUS, RRPayable, CNApproved, paidon, PaymentMode, LocationName) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);")
